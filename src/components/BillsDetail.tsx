import imgCatInvoice from "figma:asset/4a424ced8b184ed98a6c8211881ae4c82764984b.png";
import WeeklyReport from "./WeeklyReport";
import type { Transaction } from "../App";

type TimePeriod = 'week' | 'month' | 'year';

interface BillsDetailProps {
  isOpen: boolean;
  onClose: () => void;
  isDarkMode?: boolean;
...
export default function BillsDetail({ 
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative w-full h-full rounded-[20px] border-4 border-black shadow-[8px_8px_0px_0px_#000000] overflow-hidden bg-[#D9D9D9]">
          <img 
            src={imgCatInvoice} 
            alt="Cool cat with sunglasses holding money" 
      ...
      >
        ...
        <div className="relative w-full h-[35px] mb-[15px]">
          <div className="absolute inset-0 bg-[#D99C42] rounded-[10px] border-2 border-black flex items-center justify-center">
        ...
        <div className="flex justify-around items-center px-[20px]">
          ...
          >
            ...
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold text-[12px] text-black">On-Time Payer</p>
          </div>
          ...
          >
            ...
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold text-[12px] text-black">Debt Destroyer</p>
          </div>
          ...
          >
            ...
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold text-[12px] text-black">Bill Buster</p>
          </div>
