import svgPaths from "../imports/svg-o4yzhu6s5s";
import imgCatInCar from "figma:asset/01d10e83ebf2b8dec92450b13a863ef242c3e0df.png";
    ...
    >
      ...
      >
        ...
        <div className="relative w-full h-[35px] mb-[15px]">
          <div className="absolute inset-0 bg-[#6E86A9] rounded-[10px] border-2 border-black flex items-center justify-center">
        ...
        <div className="flex justify-around items-center px-[20px]">
          ...
          >
            <div className="w-[80px] h-[80px] rounded-full border-4 border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)] flex items-center justify-center overflow-hidden">
              <div className="w-[60px] h-[60px] rounded-full bg-[#D4A574] flex items-center justify-center">
                <span className="text-[40px]">🏆</span>
              </div>
            </div>
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold text-[12px] text-black">Road Master</p>
          </div>
          ...
          >
            ...
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold text-[12px] text-black">Eco Saver</p>
          </div>
          ...
          >
            <div className="w-[80px] h-[80px] rounded-full border-4 border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)] flex items-center justify-center overflow-hidden">
              <div className="w-[60px] h-[60px] rounded-full bg-[#E8C85E] flex items-center justify-center">
                <span className="text-[40px]">💰</span>
              </div>
            </div>
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold text-[12px] text-black">Money Saver</p>
          </div>
