...
export default function SplashScreen() {
  return (
    <div className="bg-white relative size-full" data-name="Splash">
      <div className="absolute h-[297px] left-[73px] pointer-events-none top-[250px] w-[303px]" data-name="msu_iit_logo-removebg-preview 1">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover size-full" src={imgMsuIitLogoRemovebgPreview1} />
      </div>
