import imgCatStudent from "figma:asset/d4409c14ff92daaac7d89a7dd9bb04054ef8dca8.png";
    ...
    >
      ...
      >
        <div className="relative w-full h-full rounded-[20px] border-4 border-black shadow-[8px_8px_0px_0px_#000000] overflow-hidden bg-white">
          <img 
            src={imgCatStudent} 
            alt="Cat studying at desk with books and laptop" 
      ...
      >
        ...
        <div className="relative w-full h-[35px] mb-[15px]">
          <div className="absolute inset-0 bg-[#75689C] rounded-[10px] border-2 border-black flex items-center justify-center">
        ...
        <div className="flex justify-around items-center px-[20px]">
          ...
          >
            ...
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold text-[12px] text-black">Brainiac</p>
          </div>
          ...
          >
            <div className="w-[80px] h-[80px] rounded-full border-4 border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)] flex items-center justify-center overflow-hidden">
              <div className="w-[60px] h-[60px] rounded-full bg-[#75689C] flex items-center justify-center">
                <span className="text-[40px]">📖</span>
              </div>
            </div>
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold text-[12px] text-black">Deep Focus</p>
          </div>
          ...
          >
            ...
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold text-[12px] text-black">Tech Whiz</p>
          </div>
