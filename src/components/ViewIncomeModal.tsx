...
import svgPathsIncome from "../imports/svg-income-history";
...
function EditButton({ onClick }: { onClick: () => void }) {
  return (
    <div className="absolute contents left-[32px] top-[826px]" data-name="Edit Button">
      <div 
        className="absolute bg-[#e5d0ac] h-[53.541px] left-[32px] rounded-[15px] top-[826px] w-[285px] cursor-pointer hover:bg-[#d9c49d] transition-colors"
        onClick={onClick}
      >
...
function DeleteButton({ onClick }: { onClick: () => void }) {
  return (
    <div className="absolute contents left-[327px] top-[826px]" data-name="Delete Button">
      <div 
        className="absolute bg-[#b45c4c] h-[53.541px] left-[327px] rounded-[15px] top-[826px] w-[68px] cursor-pointer hover:bg-[#a34d3d] transition-colors flex items-center justify-center"
        onClick={onClick}
      >
        <div aria-hidden="true" className="absolute border border-[#303030] border-solid inset-[-1px] pointer-events-none rounded-[16px]" />
        <Trash2 className="size-6 text-white relative z-10" />
      </div>
    </div>
  );
}
  ...
  return (
    <>
      <div className="absolute inset-0 bg-white z-50" data-name="View Income">
        ...
        {/* Dollar sign icon */}
        <div className="absolute left-[69.5px] size-[21px] top-[521.5px]" data-name="Dollar sign">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21 21">
            <g clipPath="url(#clip0_6_292)" id="Dollar sign">
              <path d={svgPathsIncome.p48e69c0} id="Icon" stroke="#1E1E1E" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" />
            </g>
            <defs>
        ...
        {/* Card type indicator icon (small dollar sign in corner) */}
