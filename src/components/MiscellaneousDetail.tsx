import imgCatAccountant from "figma:asset/7365f651c996365d7f9f0d56eafd06db7ca015ae.png";
import WeeklyReport from "./WeeklyReport";
import type { Transaction } from "../App";

type TimePeriod = 'week' | 'month' | 'year';

interface MiscellaneousDetailProps {
  isOpen: boolean;
  onClose: () => void;
  isDarkMode?: boolean;
...
export default function MiscellaneousDetail({ 
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative w-full h-full rounded-[20px] border-4 border-black shadow-[8px_8px_0px_0px_#000000] overflow-hidden bg-[rgba(217,217,217,0.5)]">
          <img 
            src={imgCatAccountant} 
            alt="Cat with piggy bank at desk managing finances" 
      ...
      >
        ...
        <div className="relative w-full h-[35px] mb-[15px]">
          <div className="absolute inset-0 bg-[#B5AFA8] rounded-[10px] border-2 border-black flex items-center justify-center">
        ...
        <div className="flex justify-around items-center px-[20px]">
          ...
          >
            ...
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold text-[12px] text-black">Budget Boss</p>
          </div>
          ...
          >
            <div className="w-[80px] h-[80px] rounded-full border-4 border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)] flex items-center justify-center overflow-hidden">
              <div className="w-[60px] h-[60px] rounded-full bg-[#6E86A9] flex items-center justify-center">
                <span className="text-[40px]">🎯</span>
              </div>
            </div>
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold text-[12px] text-black">Expense Tracker</p>
          </div>
          ...
          >
            <div className="w-[80px] h-[80px] rounded-full border-4 border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)] flex items-center justify-center overflow-hidden">
              <div className="w-[60px] h-[60px] rounded-full bg-[#D99C42] flex items-center justify-center">
                <span className="text-[40px]">💡</span>
              </div>
            </div>
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold text-[12px] text-black">Savvy Spender</p>
          </div>
