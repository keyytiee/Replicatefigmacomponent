import imgCatPayingBills from "figma:asset/86f617395c1f707e520658f0a0b388b5117ed872.png";
import WeeklyReport from "./WeeklyReport";
import type { Transaction } from "../App";

type TimePeriod = 'week' | 'month' | 'year';

interface UtilitiesDetailProps {
  isOpen: boolean;
  onClose: () => void;
  isDarkMode?: boolean;
    ...
    >
      ...
      >
        <div className="relative w-full h-full rounded-[20px] border-4 border-black shadow-[8px_8px_0px_0px_#000000] overflow-hidden bg-white">
          <img 
            src={imgCatPayingBills} 
            alt="Cat paying utility bills at counter" 
      ...
      >
        ...
        <div className="relative w-full h-[35px] mb-[15px]">
          <div className="absolute inset-0 bg-[#4A506F] rounded-[10px] border-2 border-black flex items-center justify-center">
        ...
        <div className="flex justify-around items-center px-[20px]">
          ...
          >
            ...
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold text-[12px] text-black">Early Bird</p>
          </div>
          ...
          >
            <div className="w-[80px] h-[80px] rounded-full border-4 border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)] flex items-center justify-center overflow-hidden">
              <div className="w-[60px] h-[60px] rounded-full bg-[#8BAA4E] flex items-center justify-center">
                <span className="text-[40px]">⚡</span>
              </div>
            </div>
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold text-[12px] text-black">Energy Saver</p>
          </div>
          ...
          >
            <div className="w-[80px] h-[80px] rounded-full border-4 border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)] flex items-center justify-center overflow-hidden">
              <div className="w-[60px] h-[60px] rounded-full bg-[#4A506F] flex items-center justify-center">
                <span className="text-[40px]">💧</span>
              </div>
            </div>
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold text-[12px] text-black">Leak Detective</p>
          </div>
